 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * | CapsL  |   1  |   2  |   3  |   4  |   5  |CMD+C |           | CMD+A |   6  |   7  |   8  |   9  |   0  |   -    |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+---------|
 * | TAB    |   Q  |   W  |   E  |   R  |   T  |CMD+V |           |  L1   |   Y  |   U  |   I  |   O  |   P  |   \    |
 * |--------+------+------+------+------+------|      |           |       |------+------+------+------+------+--------|
...
[BASE] = KEYMAP(  // layer 0 : default
        // left hand
        KC_CAPSLOCK,    KC_1,           KC_2,   KC_3,   KC_4,   KC_5,   LGUI(KC_C),
        ...
        // right hand
        // changed right control ctrl/esc function from CTL_T(KC_ESC) to KC_RCTL as it was too slow for my alfred clipboard
             LGUI(KC_A),  KC_6,   KC_7,   KC_8,   KC_9,   KC_0,             KC_MINS,
 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |        |  F1  |  F2  |  F3  |  F4  |  F5  |CMD-X |           |      |  F6  |  F7  |  F8  |  F9  |  F10 |   F11  |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |        |   !  |   @  |   {  |   }  |   |  |CTRL-C|           |      |   Up |   7  |   8  |   9  |   *  |   F12  |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |   #  |   $  |   (  |   )  |   `  |------|           |------| Down |   4  |   5  |   6  |   +  |        |
...
[SYMB] = KEYMAP(
       // left hand
       KC_TRNS,KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  LGUI(KC_X),
       KC_TRNS,KC_EXLM,KC_AT,  KC_LCBR,KC_RCBR,KC_PIPE,RCTL(KC_C),
